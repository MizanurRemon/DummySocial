package com.example.dummysocial.Tab
...
@Composable
fun TextTabs(pagerState: PagerState, list: List<String>) {
    ...
    TabRow(
        ...
        backgroundColor = if (isNightMode(LocalContext.current)) colorResource(id = R.color.default_color) else colorResource(
            id = R.color.white
        ),
